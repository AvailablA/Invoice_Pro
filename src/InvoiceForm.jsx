...
const InvoiceForm = () => {
  ...
  return (
    <VStack spacing={4} bg="rgb(224,224,224)" border="2px solid black" p={50} borderRadius="md" boxShadow="lg" w="100%" maxW="1100px" m="auto">
      <HStack spacing={8} justifyContent="space-between" alignItems="start" w="100%">
        ...
        <Box bg={bgColor} border="1px solid #ddd" p={4} borderRadius="md" w="48%">
          <FormControl>
            ...
            <select value={selectSellerParty?.name || ""} onChange={sellerPartySelect}>
        ...
        <Box bg={bgColor} border="1px solid #ddd" p={4} borderRadius="md" w="48%">
          <FormControl>
            ...
            <select value={selectBuyerParty?.name || ""} onChange={buyerPartySelect}>
      ...
      {/* Product Information */}
      <FormControl as="form" onSubmit={handleSubmit} w="100%">
        <Text>Product Description</Text>
        <Text>Product Name: </Text>
        <Input type="text" placeholder="Enter the Product name" value={productName} onChange={handleName} />

        <Text>Product HSN Code</Text>
        <Input type="text" placeholder="Enter Product HSN Code" value={productHSNCode} onChange={handleCode} />

        <Text>Product Quantity in Kg</Text>
        <Input type="text" placeholder="Quantity" value={productQuantity} onChange={handleQuantity} />

        <Text>Product Rate in Kg</Text>
        <Input type="text" placeholder="Rate" value={productRate} onChange={handleRate} />
